      ...
      <div className='wrapper--sky-op-9'>
        <div className='h-full flex-center-all'>
          <div className='px-2'>
            ...
            <h1 className='greeting'>Mabuhay! <span className='font-normal'>I am Rafael Labrado Pizarro</span></h1>

            <div className='flex gap-2'>
              <h2 className='connect ucase font-normal'>let's connect</h2>
              ...
              <ul className="flex gap-2">
                <li>
                  ...
                  <svg className="connect-icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
